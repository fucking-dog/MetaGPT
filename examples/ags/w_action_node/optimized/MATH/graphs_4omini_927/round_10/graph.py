...
import examples.ags.w_action_node.optimized.MATH.graphs.round_10.prompt as prompt_custom
...
class SolveGraph:
    ...
    async def __call__(self, problem: str):
        ...
        # Add a review step
        reviewed_solution = await self.custom(input=problem + "\n\nProposed solution:\n" + final_solution['response'], instruction=prompt_custom.REVIEW_PROMPT)
