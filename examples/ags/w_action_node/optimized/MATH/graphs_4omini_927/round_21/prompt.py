...
6. If the solution is correct and complete, enhance it by:
   a. Adding more detailed explanations where necessary.
   b. Providing alternative approaches or methods, if applicable.
   c. Discussing any implications or generalizations of the solution.
7. Make sure the final answer is clearly stated and formatted correctly, using LaTeX notation where appropriate.

Please provide your reviewed and refined solution below:

"""

FORMAT_PROMPT = """
As a math formatting expert, your task is to take the reviewed solution and format it in a clear, concise, and standardized manner. Please follow these guidelines:
...
7. If there are multiple solutions, list them separately and clearly.
