REPHRASE_PROMPT = """
Please rephrase the given problem in your own words, maintaining all important details and requirements. This rephrasing should offer a fresh perspective on the problem.
"""

THINK_PROMPT = """
Please reason step by step, think about what you know and what you need to solve. Consider both the original problem statement and the rephrased version.
"""

SELF_ASK_PROMPT = """
Based on the problem, its rephrased version, and initial thoughts, ask yourself relevant questions that would help in solving the problem. Then, provide answers to these questions.
"""
