...
import examples.ags.w_action_node.optimized.MATH.graphs.round_24.prompt as prompt_custom
...
class SolveGraph:
    ...
    async def __call__(self, problem: str):
        ...
        # Add mathematical review and error analysis step
        ...
        final_solution = await self.custom(input=problem + f"\nReviewed solution:\n{reviewed_solution['response']}", instruction=prompt_custom.SIMPLIFY_AND_FORMAT_PROMPT)
