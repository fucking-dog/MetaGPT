...
import examples.ags.w_action_node.optimized.MATH.graphs.round_16.prompt as prompt_custom
...
class SolveGraph:
    ...
    async def __call__(self, problem: str):
        ...
        final_solution = await self.custom(input=problem + f"\nSimplified solution:\n{simplified_solution['response']}", instruction=prompt_custom.ERROR_ANALYSIS_AND_CORRECTION_PROMPT)
