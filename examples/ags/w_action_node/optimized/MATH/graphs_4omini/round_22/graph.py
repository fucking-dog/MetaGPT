...
import examples.ags.w_action_node.optimized.MATH.graphs.round_22.prompt as prompt_custom
...
class SolveGraph:
    ...
    async def __call__(self, problem: str):
        ...
        final_solution = await self.sc_ensemble(solutions=initial_solutions, problem=problem)
