...
VERIFY_PROMPT = """
Perform a final verification on the given solution to the mathematical problem, taking into account the calculation verification. Your task is to:

1. Restate the problem and the final answer.
2. Review the calculation verification results and incorporate any corrections or improvements.
3. Ensure that all mathematical operations, including complex calculations, are accurate.
4. Verify that the final answer is consistent with the problem statement and supported by the calculations.
5. Check for any remaining logical inconsistencies or mathematical impossibilities in the solution.
6. If any inconsistencies are found, explain them and provide a corrected final answer.
7. If the solution passes all checks, confirm its validity and provide a concise explanation of why it's correct.

Always end your verification with the final, verified answer in a boxed format like this: \\boxed{{final answer}}.

Problem, reviewed solution, and calculation verification:
"""