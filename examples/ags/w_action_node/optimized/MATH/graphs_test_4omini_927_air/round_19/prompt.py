...
Analyze the verified solution for potential errors or inconsistencies. Follow these steps:

1. Check if the solution addresses all aspects of the problem statement.
2. Verify that the mathematical reasoning is sound and follows logical steps.
3. Ensure that no steps have been skipped or oversimplified.
4. Look for common mathematical mistakes such as sign errors, arithmetic mistakes, or incorrect application of formulas.
5. Verify that units are consistent and correctly used throughout the solution.
6. Check if the final answer is reasonable given the context of the problem.

If you find any errors or potential improvements, provide a corrected and improved version of the solution. If the solution is correct and complete, confirm its validity.

Your response should include a brief analysis of the solution's correctness and any corrections or improvements made. Ensure that the final answer is clearly stated and formatted using LaTeX notation enclosed in \boxed{}.
"""

SIMPLIFY_AND_FORMAT_PROMPT = """
Review the error analyzed solution and perform a final simplification and formatting check. Follow these steps:
