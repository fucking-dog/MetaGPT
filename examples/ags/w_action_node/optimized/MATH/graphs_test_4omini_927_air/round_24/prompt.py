...
MATH_REVIEW_PROMPT = """
Perform a thorough mathematical review and error analysis of the verified solution. Follow these steps:

1. Check all mathematical operations for accuracy, including arithmetic, algebraic, and geometric calculations.
2. Verify that all mathematical properties and theorems are correctly applied.
3. Ensure that the solution uses appropriate mathematical notation and terminology.
4. Look for any logical gaps or unjustified assumptions in the solution.
5. If applicable, consider edge cases or special conditions that might affect the solution.
6. Analyze the solution for potential simplifications or more elegant approaches.

If you find any errors or areas for improvement, provide a corrected or optimized solution. If the solution is correct and optimal, restate the final answer.

Your response should focus on the mathematical aspects of the solution and any improvements made. Explain any changes or confirmations clearly but concisely.
